...
describe('FileSizePipe', () => {
  ...
  it('should transform bytes', () => {
    ...
    expect(pipe.transform(1000 * 1000)).toEqual('1.0 MB');
    expect(pipe.transform(1234 * 1000)).toEqual('1.2 MB');
    expect(pipe.transform(1274 * 1000)).toEqual('1.3 MB');
    expect(pipe.transform(20 * 1000 * 1000)).toEqual('20.0 MB');
    expect(pipe.transform(100 * 1000 * 1000)).toEqual('100.0 MB');
    expect(pipe.transform(1000 * 1000 * 1000)).toEqual('1.0 GB');
  });
